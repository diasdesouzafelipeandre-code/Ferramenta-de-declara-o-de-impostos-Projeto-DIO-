# Ferramenta-de-declara-o-de-impostos-Projeto-DIO-
Ferramenta de declaração de inpostos feita seguindo o projeto da DIO, me limitando as funções do Excel WEB
...
Me atentando as limitações do excel WEB
